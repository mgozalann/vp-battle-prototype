...
public abstract class CharacterBase : MonoBehaviour, IDamageable
{
    ...
    private float _recheckTargetTimer;
    private const float RecheckTargetInterval = 2.5f; // saniyede 1 kez kontrol et
    ...
    protected virtual void Update()
    {
        ...
        if (_targetEnemy == null || _targetEnemy.IsDead || _recheckTargetTimer <= 0f)
        {
            _targetEnemy = FindNearestEnemy();
            _recheckTargetTimer = RecheckTargetInterval;
        }
